<div class="eachDayAct">
    <p class="eachDayActTitle"> {{date('d M', strtotime($query))}} </p>
    <button class="accordion" id="accordion" aria-describedby="eachDayActTitle"> Actividades disponibles <i class='bx bxs-chevron-down'></i> </button>
        <div class="panel">
