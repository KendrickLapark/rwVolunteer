$(() => { 
    ...
    var hidden_bc = getComputedStyle(document.querySelector('.mainDataVolAct .mainData .hidden')).backgroundColor;
    var hidden_c = getComputedStyle(document.querySelector('.mainDataVolAct .mainData .hidden p')).color;
    var hidden_button_bc = getComputedStyle(document.querySelector('.mainDataVolAct .mainData .hidden button')).backgroundColor;
    ...
    function defaultColors(){
        ...
        $('.hidden .eachRow p').css('color', hidden_c);
