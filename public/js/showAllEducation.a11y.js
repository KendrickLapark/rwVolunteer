    ...
    function disable_greyScale(){
        ...
        $('#ti4').click(function(){
            ...
            if(high_contrast){
                ...
                $('.sidebar span, .toolbar-inner, .toolbar-text, .icon-overlay svg, p, div, span, button, h1, i, .toolbar-item svg, a').css('color', '#00FFFF');
        ...
        $('#ti5').click(function(){
            ...
            if(negative_contrast){
                ...
                defaultColors();
                $('div:not(.slide, .slider, .slides, #main, .navigation-auto').css('background', 'black');
                $('.notifyTrayIns, .sectionIncomplete, .sidebar, .sidebar li, li, .home-section, .mainData, .icon-overlay, .divTime, nav, .toolbar-inner, form, button, .profile-details, .row').css('background', 'black');
                $('.sidebar span, .toolbar-inner, .toolbar-text, .icon-overlay svg, p, div, span, button, h1, i, .toolbar-item svg, a').css('color', 'yellow');
             }
        ...
        $('#ti6').click(function(){
            ...
            if(white_background){
                ...
                defaultColors();
                $('.notifyTrayIns, .sectionIncomplete, .sidebar, .sidebar li, li, .home-section, .mainData, .icon-overlay, .divTime, nav, .toolbar-inner, form, button, .profile-details, .row').css('background', 'white');
                $('.sidebar span, .toolbar-inner, .toolbar-text, p, div, span, .icon-overlay svg, button, h1, i, .toolbar-item svg, a, .boton-delete-user i').css('color', 'black');                
             }
