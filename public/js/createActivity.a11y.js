$(() => { 
    ...
    var select_c = getComputedStyle(document.querySelector('select')).color; 
    ...
    function disable_greyScale(){
        ...
        $('#ti4').click(function(){
            ...
            if(high_contrast){
                ...
                $('.notifyTrayIns, .sectionIncomplete, .sidebar, .sidebar li, li, .home-section, .mainData, input, select, .divTime, nav, .toolbar-inner, form, button, .profile-details, .row').css('background', 'black');
                $('.sidebar span, .toolbar-inner, .toolbar-text, p, div, span, button, h1, i, input, select, .toolbar-item svg, a').css('color', '#00FFFF');
        ...
        $('#ti6').click(function(){
            ...
            if(white_background){
                ...
                defaultColors();
                $('.notifyTrayIns, .sectionIncomplete, .sidebar, .sidebar li, li, .home-section, .mainData, input, select, .divTime, nav, .toolbar-inner, form, button, .profile-details, .row').css('background', 'white');
