$(() => { 
    ...
    var mainTrayLogNot_bc = getComputedStyle(document.querySelector('.mainTrayLogNot')).backgroundColor;
    ...
    function defaultColors(){
        ...
        $('.mainTrayLogNot').css('background', mainTrayLogNot_bc);

        $('.mainTrayLogNot').find('div').each(function(){
            $(this).css('background', mainTrayLogNot_bc);
